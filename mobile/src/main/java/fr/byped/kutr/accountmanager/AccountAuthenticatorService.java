...
public class AccountAuthenticatorService extends Service {
    ...
    private static class AccountAuthenticatorImpl extends AbstractAccountAuthenticator {
        ...
        public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options)
            ...
            Log.d(AccountAuthenticatorService.TAG, "Adding new account");
            Bundle reply = new Bundle();

            Log.d(AccountAuthenticatorService.TAG, "The auth token type is " + authTokenType);
            Intent i = new Intent(mContext, AddAccountActivity.class);
            i.setAction("addnewaccount");
